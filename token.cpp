...
std::ostream& operator << ( std::ostream& outs, const Token & tok )
{
    switch (tok.type) {
        ...
        case Token::END_FOR: outs << "TOKEN(END_FOR)"; break;
        case Token::DO: outs << "TOKEN(DO)"; break;
        case Token::IN: outs << "TOKEN(IN)"; break;
        case Token::STR: outs << "TOKEN(STR)"; break;
        case Token::CORCHETE_I :outs << "TOKEN(CORCHETE_I)"; break;
        case Token::CORCHETE_D: outs << "TOKEN(CORCHETE_D)"; break;
